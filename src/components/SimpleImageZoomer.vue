<template>
    <div class="product-zoomer"
        ...
        <div class="image-container">
            <img :src="imageUrl" alt="Product Image" ref="productImage" width="400" />
        </div>
...
export default {
    ...
    methods: {
        handleMouseMove(event) {
            ...
            const zoomedWidth = container.width / this.zoomFactor;
            const zoomedHeight = container.height / this.zoomFactor;
            ...
            this.zoomedImageStyle.backgroundImage = `url(${this.imageUrl})`;
